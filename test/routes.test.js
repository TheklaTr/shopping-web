...
const encodeCredentials = (username, password) => Buffer.from(`${username}:${password}`, 'utf-8').toString('base64');
    ...
    describe('handleRequest()', () => {
        describe('General Server Functionality', () => {
            ...
            it('should respond with "405 Method Not Allowed" to an unsupported method', async () => {
                const response = await chai.request(handleRequest).post(usersUrl).set('Accept', contentType).send({});
        ...
        describe('Registration: POST /api/register', () => {
            ...
            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const user = getTestUser();
                const response = await chai.request(handleRequest).post(registrationUrl).set('Accept', 'text/html').send(user);
                expect(response).to.have.status(406);
            });
            ...
            it('should respond with "400 Bad Request" when request body is not valid JSON', async () => {
                ...
                const response = await chai.request(handleRequest).post(registrationUrl).set('Accept', contentType).send(body);
            ...
            it('should respond with "400 Bad Request" when email is missing', async () => {
                ...
                const response = await chai.request(handleRequest).post(registrationUrl).set('Accept', contentType).send(user);
        ...
        describe('Viewing all users: GET /api/users', () => {
            ...
            it('should respond with Basic Auth Challenge when Authorization header is empty', async () => {
                const response = await chai.request(handleRequest).get(usersUrl).set('Accept', contentType).set('Authorization', '');
            ...
            it('should respond with Basic Auth Challenge when Authorization header is not properly encoded', async () => {
                const response = await chai.request(handleRequest).get(usersUrl).set('Accept', contentType).set('Authorization', `Basic ${adminUser.email}:${adminUser.password}`);
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const response = await chai.request(handleRequest).get(usersUrl).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`);
            ...
            it('should respond with "403 Forbidden" when customer credentials are received', async () => {
                const response = await chai.request(handleRequest).get(usersUrl).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`);

                expect(response).to.have.status(403);
            });

            it('should respond with JSON when admin credentials are received', async () => {
                const response = await chai.request(handleRequest).get(usersUrl).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
        ...
        describe('Viewing a single user: GET /api/users/{id}', () => {
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const response = await chai.request(handleRequest).get(url).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`);
            ...
            it('should respond with "403 Forbidden" when customer credentials are received', async () => {
                const response = await chai.request(handleRequest).get(url).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`);

                expect(response).to.have.status(403);
            });

            it('should respond with "406 Not Acceptable" when Accept header is missing', async () => {
                const response = await chai.request(handleRequest).get(url).set('Authorization', `Basic ${adminCredentials}`);
                expect(response).to.have.status(406);
            });

            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const response = await chai.request(handleRequest).get(url).set('Accept', 'text/html').set('Authorization', `Basic ${adminCredentials}`);
                expect(response).to.have.status(406);
            });

            it('should respond with JSON when admin credentials are received', async () => {
                const response = await chai.request(handleRequest).get(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
            ...
            it('should respond with status code 404 when user does not exist', async () => {
                const response = await chai.request(handleRequest).get(`${usersUrl}/${unknownId}`).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
        ...
        describe('Updating users: PUT /api/users/{id}', () => {
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`);
            ...
            it('should respond with "403 Forbidden" when customer credentials are received', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`).send(user);

                expect(response).to.have.status(403);
            });

            it('should respond with "406 Not Acceptable" when Accept header is missing', async () => {
                const response = await chai.request(handleRequest).put(url).set('Authorization', `Basic ${adminCredentials}`).send(user);
                expect(response).to.have.status(406);
            });

            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', 'text/html').set('Authorization', `Basic ${adminCredentials}`).send(user);
                expect(response).to.have.status(406);
            });

            it('should update role when admin credentials are received', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(user);
            ...
            it('should only update role', async () => {
                ...
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(userWithExtra);
            ...
            it('should respond with "400 Bad Request" when role is not valid', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send({ role: generateRandomString() });
            ...
            it('should respond with status code 404 when user does not exist', async () => {
                const response = await chai.request(handleRequest).put(`${usersUrl}/${unknownId}`).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(user);
        ...
        describe('Deleting users: DELETE /api/users/{id}', () => {
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const response = await chai.request(handleRequest).delete(url).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`);
            ...
            it('should respond with "403 Forbidden" when customer credentials are received', async () => {
                const response = await chai.request(handleRequest).delete(url).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`);

                expect(response).to.have.status(403);
            });

            it('should respond with "406 Not Acceptable" when Accept header is missing', async () => {
                const response = await chai.request(handleRequest).delete(url).set('Authorization', `Basic ${adminCredentials}`);
                expect(response).to.have.status(406);
            });

            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const response = await chai.request(handleRequest).delete(url).set('Accept', 'text/html').set('Authorization', `Basic ${adminCredentials}`);
                expect(response).to.have.status(406);
            });

            it('should delete user when admin credentials are received', async () => {
                const response = await chai.request(handleRequest).delete(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
            ...
            it('should respond with status code 404 when user does not exist', async () => {
                const response = await chai.request(handleRequest).delete(`${usersUrl}/${unknownId}`).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
        ...
        describe('Viewing all products: GET /api/products', () => {
            it('should respond with "401 Unauthorized" when Authorization header is missing', async () => {
                const response = await chai.request(handleRequest).get(productsUrl).set('Accept', contentType);
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const response = await chai.request(handleRequest).get(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`);
            ...
            it('should respond with Basic Auth Challenge when Authorization header is empty', async () => {
                const response = await chai.request(handleRequest).get(productsUrl).set('Accept', contentType).set('Authorization', '');
            ...
            it('should respond with Basic Auth Challenge when Authorization header is not properly encoded', async () => {
                const response = await chai.request(handleRequest).get(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${adminUser.email}:${adminUser.password}`);
            ...
            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const response = await chai.request(handleRequest).get(productsUrl).set('Accept', 'text/html');

                expect(response).to.have.status(406);
            });

            it('should respond with JSON when admin credentials are received', async () => {
                const response = await chai.request(handleRequest).get(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
            ...
            it('should respond with JSON when customer credentials are received', async () => {
                const response = await chai.request(handleRequest).get(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`);
        ...
        describe('Viewing a single product: GET /api/products/{id}', () => {
            ...
            it('should respond with status code 404 when product does not exist', async () => {
                const response = await chai.request(handleRequest).get(`${productsUrl}/${unknownId}`).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
        ...
        describe('Updating products: PUT /api/products/{id}', () => {
            ...
            it('should respond with "403 Forbidden" when customer credentials are received', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`).send(product);

                expect(response).to.have.status(403);
            });

            it('should respond with "406 Not Acceptable" when Accept header is missing', async () => {
                const response = await chai.request(handleRequest).put(url).set('Authorization', `Basic ${adminCredentials}`).send(product);
                expect(response).to.have.status(406);
            });

            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', 'text/html').set('Authorization', `Basic ${adminCredentials}`).send(product);
                expect(response).to.have.status(406);
            });

            it('should update product when admin credentials are received', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(product);
            ...
            it('should allow partial update of product properties', async () => {
                ...
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(productWithPartialData);
            ...
            it('should respond with "400 Bad Request" when name is empty', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send({ name: '' });
            ...
            it('should respond with "400 Bad Request" when price is not a number', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send({ price: generateRandomString() });
            ...
            it('should respond with "400 Bad Request" when price is 0 (zero)', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send({ price: 0 });
            ...
            it('should respond with "400 Bad Request" when price is negative', async () => {
                const response = await chai.request(handleRequest).put(url).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send({ price: -2.5 });
            ...
            it('should respond with status code 404 when product does not exist', async () => {
                const response = await chai.request(handleRequest).put(`${productsUrl}/${unknownId}`).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(product);
        ...
        describe('Deleting products: DELETE /api/products/{id}', () => {
            ...
            it('should respond with status code 404 when user does not exist', async () => {
                const response = await chai.request(handleRequest).delete(`${productsUrl}/${unknownId}`).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
        ...
        describe('Create a new product: POST /api/products', () => {
            it('should respond with "406 Not Acceptable" when Accept header is missing', async () => {
                ...
                const response = await chai.request(handleRequest).post(productsUrl).set('Authorization', `Basic ${adminCredentials}`).send(product);
                expect(response).to.have.status(406);
            });

            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const product = getTestProduct();
                const response = await chai.request(handleRequest).post(productsUrl).set('Accept', 'text/html').set('Authorization', `Basic ${adminCredentials}`).send(product);
                expect(response).to.have.status(406);
            });

            it('should respond with "401 Unauthorized" when Authorization header is missing', async () => {
                const product = getTestProduct();
                const response = await chai.request(handleRequest).post(productsUrl).set('Accept', contentType).send(product);
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const product = getTestProduct();
                const response = await chai.request(handleRequest).post(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`).send(product);
            ...
            it('should respond with "403 Forbidden" when customer credentials are received', async () => {
                const product = getTestProduct();
                const response = await chai.request(handleRequest).post(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`).send(product);
            ...
            it('should respond with "400 Bad Request" when request body is not valid JSON', async () => {
                ...
                const response = await chai.request(handleRequest).post(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(body);
                expect(response).to.have.status(400);
            });
            ...
            it('should respond with "400 Bad Request" when name is missing', async () => {
                ...
                const response = await chai.request(handleRequest).post(productsUrl).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(product);
        ...
        describe('Viewing all orders: GET /api/orders', () => {
            it('should respond with "401 Unauthorized" when Authorization header is missing', async () => {
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', contentType);
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`);
            ...
            it('should respond with Basic Auth Challenge when Authorization header is empty', async () => {
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', contentType).set('Authorization', '');
            ...
            it('should respond with Basic Auth Challenge when Authorization header is not properly encoded', async () => {
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${adminUser.email}:${adminUser.password}`);
            ...
            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', 'text/html');

                expect(response).to.have.status(406);
            });

            it('should respond with JSON when admin credentials are received', async () => {
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);
            ...
            it('should respond with JSON when customer credentials are received', async () => {
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`);
            ...
            it('should respond with correct data when customer credentials are received', async () => {
                const customer = allUsers.find((user) => user.email === customerUser.email && user.role === 'customer');
                const ordersData = JSON.parse(JSON.stringify(allOrders.filter((order) => order.customerId.toString() === customer.id)));
                const response = await chai.request(handleRequest).get(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`);
        ...
        describe('Viewing a single order: GET /api/orders/{id}', () => {
            ...
            it('should respond with status code 404 when order does not exist', async () => {
                const response = await chai.request(handleRequest).get(`${ordersUrl}/${unknownId}`).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`);

                expect(response).to.have.status(404);
            });

            it('should respond with status code 404 when order exists but the owner is not the current customer', async () => {
                const order = allOrders.find((order) => order.customerId.toString() !== testOrder.customerId.toString());
                const response = await chai.request(handleRequest).get(`${ordersUrl}/${order.id}`).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`);
        ...
        describe('Create a new order: POST /api/orders', () => {
            it('should respond with "406 Not Acceptable" when Accept header is missing', async () => {
                ...
                const response = await chai.request(handleRequest).post(ordersUrl).set('Authorization', `Basic ${customerCredentials}`).send(order);
                expect(response).to.have.status(406);
            });

            it('should respond with "406 Not Acceptable" when client does not accept JSON', async () => {
                const order = getTestOrder();
                const response = await chai.request(handleRequest).post(ordersUrl).set('Accept', 'text/html').set('Authorization', `Basic ${customerCredentials}`).send(order);
                expect(response).to.have.status(406);
            });

            it('should respond with "401 Unauthorized" when Authorization header is missing', async () => {
                const order = getTestOrder();
                const response = await chai.request(handleRequest).post(ordersUrl).set('Accept', contentType).send(order);
            ...
            it('should respond with Basic Auth Challenge when Authorization credentials are incorrect', async () => {
                const order = getTestOrder();
                const response = await chai.request(handleRequest).post(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${invalidCredentials}`).send(order);
            ...
            it('should respond with "403 Forbidden" when admin credentials are received', async () => {
                const order = getTestOrder();
                const response = await chai.request(handleRequest).post(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${adminCredentials}`).send(order);
            ...
            it('should respond with "400 Bad Request" when request body is not valid JSON', async () => {
                ...
                const response = await chai.request(handleRequest).post(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`).send(body);
                expect(response).to.have.status(400);
            });
            ...
            it('should respond with "400 Bad Request" when items is empty', async () => {
                ...
                const response = await chai.request(handleRequest).post(ordersUrl).set('Accept', contentType).set('Authorization', `Basic ${customerCredentials}`).send(order);
